...
class TestNaaradComprehensiveAPI(unittest.TestCase):
    ...
    def send_chat_request(self, message: str, conversation_id: Optional[str] = None, 
                         chat_history: Optional[List[Dict]] = None, images: Optional[List[str]] = None) -> requests.Response:
    ...
    def test_chat_basic_functionality(self):
        ...
        print(f"✅ Basic chat functionality test passed")
    ...
    def test_chat_with_conversation_context(self):
        ...
        if isinstance(data1.get("message"), dict):
            message1 = data1["message"].get("output", str(data1["message"]))
        else:
        ...
        # Extract message from nested response
        if isinstance(data2.get("message"), dict):
            message2 = data2["message"].get("output", str(data2["message"]))
        else:
            message2 = data2.get("message", "")
        
        # Check if the response contains the name (case-insensitive)
        response_text = message2.lower()
        self.assertTrue(
            "alice" in response_text or "name" in response_text,
            f"Response should mention the name or acknowledge the context. Got: {message2}"
        )
    ...
    def test_chat_with_images(self):
        ...
        test_time = time.time() - start_time
        print(f"✅ Image chat test passed")
        print(f"⏱️  Test completed in {test_time:.2f}s")
    ...
    def test_factual_questions(self):
        ...
        test_time = time.time() - start_time
        print(f"✅ Factual questions test passed")
        print(f"⏱️  Test completed in {test_time:.2f}s")
    ...
    def test_creative_requests(self):
        ...
        response = requests.post(
            f"{self.BASE_URL}/api/v1/chat",
            json={"message": "Write a short poem about AI"},
            headers=self.session.headers
        )
        ...
        test_time = time.time() - start_time
        print(f"✅ Creative requests test passed")
        print(f"⏱️  Test completed in {test_time:.2f}s")
    ...
    def test_mathematical_calculations(self):
        ...
        test_time = time.time() - start_time
        print(f"✅ Mathematical calculations test passed")
        print(f"⏱️  Test completed in {test_time:.2f}s")
    ...
    def test_language_translation(self):
        ...
        test_time = time.time() - start_time
        print(f"✅ Language translation test passed")
        print(f"⏱️  Test completed in {test_time:.2f}s")
    ...
    def test_llm_provider_integration(self):
        ...
        test_time = time.time() - start_time
        print(f"✅ LLM provider integration test passed")
        print(f"⏱️  Test completed in {test_time:.2f}s")
    ...
    def test_multi_agent_collaboration(self):
        ...
        response = requests.post(
            f"{self.BASE_URL}/api/v1/chat",
            json={"message": "Research the latest developments in AI and provide a comprehensive analysis"},
            headers=self.session.headers
        )
        ...
        test_time = time.time() - start_time
        print(f"✅ Multi-agent collaboration test passed")
        print(f"⏱️  Test completed in {test_time:.2f}s")
    ...
    def test_brave_search_integration(self):
        ...
        response = requests.post(
            f"{self.BASE_URL}/api/v1/chat",
            json={"message": "Search for latest AI news"},
            headers=self.session.headers
        )
        ...
        test_time = time.time() - start_time
        print(f"✅ Brave Search integration test passed")
        print(f"⏱️  Test completed in {test_time:.2f}s")
